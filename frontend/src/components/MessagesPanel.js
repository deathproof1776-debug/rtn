  ...
  if (loading) {
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-[var(--text-muted)]">Loading conversations...</div>
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col" data-testid="messages-panel">
      <div className="flex items-center gap-2 mb-4 md:mb-6">
        <ChatCircle size={22} weight="duotone" className="text-[var(--brand-primary)]" />
        ...
        <div className="flex-1 flex flex-col theme-surface border theme-border -mx-4 md:mx-0">
          <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 border-b theme-border">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] md:text-xs text-[var(--text-muted)]">Encrypted</p>
            </div>
          </div>
                ...
                <div className="flex items-center gap-2.5 md:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <h4 className="font-medium text-[var(--text-primary)] text-sm md:text-base truncate">{conv.user_name}</h4>
                    ...
                    <p className="text-xs md:text-sm text-[var(--text-muted)] truncate">{conv.last_message}</p>
                  </div>
                </div>
              </button>
            ))
